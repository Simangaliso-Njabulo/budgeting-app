        ...
        <div className="auth-card">
          <div className="auth-logo">
            <svg className="auth-logo-icon" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <rect x="8" y="16" width="48" height="36" rx="4" stroke="url(#logoGrad)" strokeWidth="3" fill="none" />
              <path d="M8 28h48" stroke="url(#logoGrad)" strokeWidth="3" />
              <circle cx="20" cy="40" r="6" fill="url(#logoGrad)" opacity="0.3" />
              <circle cx="44" cy="40" r="6" fill="url(#logoGrad)" opacity="0.3" />
            </svg>
